...
class Agenda extends CI_controller
{
  function __construct()
  {
	   ...
	   $this->load->model('m_agendapenyiar');
  }
  ...
  public function index()
  {
    ...
    $data = ($this->session->userdata('level') == "pegawai") ? $this->m_agendapenyiar->cari_agenda_pegawai($id) : $this->m_agendapenyiar->agenda_pegawai();
	...
	$x = array('judul' =>'Agenda Kegiatan Penyiar',
			  'datacount' => $datacount,
              'data'  =>$data); 
    tpl('admin/agendapenyiar/agenda',$x);
  }
  ...
  public function index2()
  {
	...
	$x = array('judul' =>'Agenda Kegiatan',
			  ...
			  'data2'  =>$dataman2,
              'data'  =>$data); 
    tpl('admin/agendapenyiar/agenda2',$x);
  ...
  public function agendacalendar()
  {
    ...
    tpl('admin/agendapenyiar/agendacalendar',$x);
  }
  ...
  public function myagendacalendar()
  {
	...
	{
      tpl('admin/agendapenyiar/myagendacalendar',$x);
	}
	else
	{
	  tpl('admin/agendapenyiar/mysagendacalendar',$x);
	}
  ...
  public function verifikasi_agenda()
  {
    ...
    tpl('admin/agendapenyiar/agendaverifikasi',$x);
  }
  ...
  public function disposisi_agenda()
  {
    ...
    tpl('admin/agendapenyiar/agendadisposisi',$x);
  }
  ...
  public function agenda_kegiatan($id_agenda)
  {
    ...
    $x = array('judul' =>'Daftar Kegiatan Agenda Pegawai',
				  ...
				  'lokasi_agenda'    => $sql['lokasi_agenda'],
              	  'data'  =>$data); 
    tpl('admin/agendapenyiar/agendakegiatan',$x);
  }
  ...
  public function verifikasiagenda_kegiatan($id_agenda)
  {
    ...
    $x = array('judul' =>'Daftar Kegiatan Agenda Pegawai',
	           'idm'=>$id_agenda,
				  ...
				  'lokasi_agenda'    => $sql['lokasi_agenda'],
              'data'  =>$data); 
    tpl('admin/agendapenyiar/verifikasiagendakegiatan',$x);
  }
  ...
  public function disposisiagenda_kegiatan($id_agenda)
  {
    ...
    $x = array('judul' =>'Disposisi Daftar Kegiatan Agenda Pegawai',
	           'idm'=>$id_agenda,
				  ...
				  'lokasi_agenda'    => $sql['lokasi_agenda'],
              'data'  =>$data); 
    tpl('admin/agendapenyiar/disposisiagendakegiatan',$x);
  }
  ...
  public function tolak_kegiatan($id='',$idm='')
  {
		...
		{   	  
			  $x = array('judul'        =>'Tolak Data Kegiatan' ,
				...
				{
				 tpl('admin/agendapenyiar/tolakkegiatan_form',$x);
				}
		...
		{   	  
			  if($sql['status_kegiatan']==0)
			  {
			   ...
			   else
			   {
				...
				{
				 tpl('admin/agendapenyiar/wakilkegiatan_form',$x);
				}
  ...
  public function agenda_pending()
  {
    ...
    $x = array('judul' =>'Pending Agenda Pegawai',
              'data'  =>$data); 
    tpl('admin/agendapenyiar/agendapending',$x);
  }
  ...
  public function agenda_approved()
  {
    ...
    $x = array('judul' =>'Apporved Agenda Pegawai',
              'data'  =>$data); 
    tpl('admin/agendapenyiar/agendaapproved',$x);
  }
  ...
  public function agenda_reject()
  {
    ...
    $x = array('judul' =>'Reject Agenda Pegawai',
              'data'  =>$data); 
    tpl('admin/agendapenyiar/agendareject',$x);
  }
  ...
  public function jabatan()
  {
   ...
   tpl('admin/agendapenyiar/jabatan',$x);
  }
  ...
  {
	  $x = array('judul'        => 'Tambah Data Agenda Penyiar' ,
				  'aksi'        => 'tambah',
				  'tanggal'=> "",
				  'jam_mulai'=> "",
				  'jam_selesai'=> "",
		...
		if(isset($_POST['kirim']))
		{
			...
			$querydatajum21 = $this->db->query("SELECT * FROM agendapegawai a INNER JOIN agenda b ON(a.id_agenda=b.id_agenda) WHERE a.id_pegawai='$idpegawai' AND b.tanggal='$tanggal' AND (b.jam_mulai >= '$jammulai2' AND b.jam_selesai <= '$jamselesai2' OR jam_mulai >='$jammulai3' AND jam_selesai <='$jamselesai2' AND a.id_type=1)");
			...
			if(!empty($datapegawai))
			{
				foreach($datapegawai as $datapegikut)
				{
					...
					$querydatajum2 = $this->db->query("SELECT * FROM agendapegawai a INNER JOIN agenda b ON(a.id_agenda=b.id_agenda) WHERE a.id_pegawai='$datapegikut' AND b.tanggal='$tanggal' AND (b.jam_mulai >= '$jammulai2' AND b.jam_selesai <= '$jamselesai2' OR jam_mulai >='$jammulai3' AND jam_selesai <='$jamselesai2' AND a.id_type=1)");
		...
		{
			 tpl('admin/agendapenyiar/agenda_form',$x);
  ...
  public function kegiatan_tambah($idm)
  {
	  $x = array('judul'        => 'Tambah Data Agenda' ,
		...
		{
		 tpl('admin/agendapenyiar/kegiatan_form',$x);
		}
  }
  ...
  public function agenda_edit($id='')
  {
	  ...
	  $x = array('judul'        =>'Edit Data Agenda' ,
		...
		if(isset($_POST['kirim']))
		{
			...
			$querydatajum21= $this->db->query("SELECT * FROM agendapegawai a INNER JOIN agenda b ON(a.id_agenda=b.id_agenda) WHERE a.id_pegawai='$idpegawai' AND b.tanggal='$tanggal' AND (b.jam_mulai >= '$jammulai2' AND b.jam_selesai <= '$jamselesai2' OR jam_mulai >='$jammulai3' AND jam_selesai <='$jamselesai2') AND b.id_agenda NOT IN($id) AND a.id_type=1");
			$querydatajumdata21=$querydatajum21->num_rows();
  ...
  public function agenda_detail($id='')
  {
	  ...
	  $x = array('judul'        =>'Detail Data Agenda' ,
	   ...
	   tpl('admin/agendapenyiar/agenda_formdetail',$x);	
  }
  ...
  public function kegiatan_detail($id='')
  {
	   ...
	   tpl('admin/agendapenyiar/kegiatan_formdetail',$x);	
  }
  ...
  public function kegiatan_hapus($id='',$idm='')
  {
	...
	public function word()
	{
		...
		$this->load->view('admin/agendapenyiar/tbl_agenda_doc',$data);
	}
