						  ...
						  <div class="box box-solid">
						   <div class="box-body">
							  ...
							  <div id="external-events">
								<a href="<?= base_url('agendamastercontrol/agenda_tambah/') ?>" class="btn btn-danger btn-sm"><i class="fa fa-wpforms"></i> Tambah Agenda</a>
...
<div class="box-body" bis_skin_checked="1">
	...
	<div style="padding-bottom: 10px;" '="" bis_skin_checked="1">
		<?php echo anchor(site_url('agendamastercontrol/myexcel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel My Agenda', 'class="btn btn-success btn-sm"'); ?>
	</div>
        ...
        var d = date.getDate(),
			...
			$('#calendar2').fullCalendar({
			  ...
			  events: [
				...
				<?php 
					 $im=0; $no=1; 
					 $jumlah=$data3->num_rows();
					 
					 foreach($data3->result_array() as $admin)
					 {
						...
						$menit2=substr($admin['jam_selesai'],3,2);
							...
							if(!empty($data))
					        {
									...
									foreach($data->result_array() as $data3row)
									{
										 if(!empty($data3row))
										 {
											 if($data3row['id_agenda']==$admin['id_agenda'])
											 {
												 $status=1;
												 break;
											 }
									...
									if(!empty($data2))
									{
										...
										foreach($data2 as $data2row)
										{
											 if(!empty($data2row))
											 {
												 if($data2row->id_agenda==$admin['id_agenda'])
												 {
													 $status=1;
													 break;
												 }
