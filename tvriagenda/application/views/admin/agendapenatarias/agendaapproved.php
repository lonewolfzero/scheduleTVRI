...
<div class="box box-warning box-solid" bis_skin_checked="1">
    ...
    <div class="box-header" bis_skin_checked="1">
      <h3 class="box-title">Kelola Data Agenda Approved</h3>
    </div>
    ...
    <div class="box-body" bis_skin_checked="1">
      ...
      <table id="example1" class="table table-bordered table-striped">
          ...
          <td>
          <a href="<?= base_url('agenda/agenda_detail/'.$admin['id_agenda']) ?>" class="btn btn-info"><i class="fa fa-eye"></a> 
          <a href="<?= base_url('agenda/agenda_edit/'.$admin['id_agenda']) ?>" class="btn btn-info"><i class="fa fa fa-pencil-square-o"></a> 
