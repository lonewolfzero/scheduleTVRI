...
<div class="box-header" bis_skin_checked="1">
	<h3 class="box-title">Kelola Data Agenda Kegiatan Redaktur</h3>
</div>
...
<div class="box-body" bis_skin_checked="1">
	...
	<div style="padding-bottom: 10px;" '="" bis_skin_checked="1">
		<a href="<?= base_url('agendaredaktur/agenda_tambah/') ?>" class="btn btn-danger btn-sm"><i class="fa fa-wpforms"></i> Tambah Agenda Redaktur</a>
		<?php echo anchor(site_url('agendaredaktur/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success btn-sm"'); ?>
		<?php echo anchor(site_url('agendaredaktur/word'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-primary btn-sm"'); ?>
	...
	<div class="dataTables_length" id="mytable_length" bis_skin_checked="1">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<?php $im=0; $no=1; foreach($data->result_array() as $admin): ?>
					...
					<a href="<?= base_url('agendaredaktur/agenda_detail/'.$admin['id_agenda']) ?>" class="btn btn-info"> <i class="fa fa-eye"></i></a> 
					<a href="<?= base_url('agendaredaktur/agenda_edit/'.$admin['id_agenda']) ?>" class="btn btn-info"> <i class="fa fa fa-pencil-square-o"></i></a> 
					<a href="<?= base_url('agendaredaktur/agenda_hapus/'.$admin['id_agenda']) ?>" onclick="return(confirm('Are You Sure Want Delete ?'))"  class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
					</td> 
					</tr>
