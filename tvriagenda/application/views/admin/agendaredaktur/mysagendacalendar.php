						  ...
						  <div class="box box-solid">
						   <div class="box-body">
							  ...
							  <div id="external-events">
								<a href="<?= base_url('agendaredaktur/agenda_tambah/') ?>" class="btn btn-danger btn-sm"><i class="fa fa-wpforms"></i> Tambah Agenda</a>
...
<div class="box-body" bis_skin_checked="1">
	...
	<div style="padding-bottom: 10px;" '="" bis_skin_checked="1">
		<?php echo anchor(site_url('agendaredaktur/myexcel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel My Agenda', 'class="btn btn-success btn-sm"'); ?>
	</div>
