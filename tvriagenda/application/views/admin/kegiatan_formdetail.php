...
<div class="box box-warning box-solid" bis_skin_checked="1">
    ...
    <div class="box-header" bis_skin_checked="1">
        <h3 class="box-title">Data Detail Kegiatan</h3>
    </div>
    ...
    <table class="table table-striped">
            ...
            <tr><th>Nama Pejawab</th><td><input type="text" name="nama_pejabat" value="<?= $nama_pejabat ?>" class="form-control" required="" readonly></td></tr>
