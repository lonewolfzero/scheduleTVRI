...
<a href="<?= base_url('laporanagenda/cetak_laporan_pegawaiagenda/'.$this->input->post('dari').'/'.$this->input->post('sampai')) ?>" class="btn btn-primary">Cetak</a>
