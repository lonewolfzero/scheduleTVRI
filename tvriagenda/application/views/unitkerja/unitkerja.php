  ...
  <div class="box box-warning box-solid" bis_skin_checked="1">
    ...
    <div class="box-header" bis_skin_checked="1">
      <h3 class="box-title">Kelola Data Unit Kerja</h3>
    </div>
    ...
    <div class="box-body" bis_skin_checked="1">
      ...
      <div style="padding-bottom: 10px;" '="" bis_skin_checked="1">
          <a href="<?= base_url('unitkerja/unitkerja_tambah/') ?>" class="btn btn-danger btn-sm"><i class="fa fa-wpforms"></i>Tambah</a>
      </div>
      ...
      <div class="dataTables_length" id="mytable_length" bis_skin_checked="1">   
         <table id="example1" class="table table-bordered table-striped">
                          ...
                          <td>
                          <a href="<?= base_url('unitkerja/unitkerja_edit/'.$admin['id_unitkerja']) ?>" class="btn btn-info"><i class="fa fa fa-pencil-square-o"></i></a> 
                          <a href="<?= base_url('unitkerja/unitkerja_hapus/'.$admin['id_unitkerja']) ?>" onclick="return(confirm('Are You Sure Want Delete ?'))" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td> 
                          </tr>
